...
class PurchaseRequestApproved extends Notification implements ShouldQueue
{
    ...
    {
        $budgetApproval = $this->purchaseRequest->budgetApproval;
        ...
        return (new MailMessage)
            ...
            ->line('Approver: ' . $this->purchaseRequest->approver->name)
            ->line('Approved Amount: ₱' . number_format($budgetApproval->approved_amount, 2))
            ->line('Approved Date: ' . $this->purchaseRequest->approved_at->format('M d, Y h:i A'))
    ...
    public function toWebPush(object $notifiable, $notification): WebPushMessage
    {
        return (new WebPushMessage)
            ...
            ->body('PR Number: ' . $this->purchaseRequest->pr_number . ' has been approved by ' . $this->purchaseRequest->approver->name)

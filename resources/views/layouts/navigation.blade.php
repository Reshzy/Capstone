    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                <!-- Notifications -->
                <div class="relative">
                    <button @click="notificationsOpen = !notificationsOpen" class="relative flex items-center p-2 text-gray-500 hover:text-gray-700 focus:outline-none">
                    ...
                    <div x-show="notificationsOpen" @click.away="notificationsOpen = false" class="absolute right-0 mt-2 w-80 bg-white border border-gray-200 rounded-md shadow-lg py-1 z-10" style="display: none;">
                        <div class="px-4 py-2 text-xs font-bold text-gray-500 bg-gray-100">
                            NOTIFICATIONS
                        </div>
                        
                        @forelse(auth()->user()->notifications->take(5) as $notification)
                            <a href="{{ $notification->data['action_url'] ?? '#' }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 {{ $notification->read_at ? '' : 'bg-blue-50' }}">
                                <p class="font-semibold">{{ $notification->data['message'] ?? 'Notification' }}</p>
                        ...
                        <div class="px-4 py-2 text-xs text-center border-t">
                            <a href="{{ route('notifications.index') }}" class="text-blue-500 hover:text-blue-700">View All Notifications</a>
                        </div>
                    </div>
                </div>
